...
import { useNavigate } from "react-router-dom";
    ...
    const navigation = [{ name: 'Dashboard', current: true, route: '/dashboard' }];
    const userNavigation = [{ name: 'Sign out', route: '/' }];
      ...
      <div className="min-h-full bg-gray-100 ">
        ...
        <header className="bg-white shadow-sm">
          <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
            <h1 className="text-lg font-semibold leading-6 text-gray-900">Dashboard Dompet Agnia</h1>
          </div>
        </header>
        <main>
